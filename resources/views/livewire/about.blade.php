    ...
    <div class="overflow prose prose-slate prose-p:text-lg dark:prose-invert mx-auto max-w-screen-xl">
        ...
        <section class="flex flex-col items-center justify-center mx-auto gap-12 py-16 md:py-18 lg:py-20 fade-on-scroll">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-2 gap-12">
                <x-developer-card avatar="{{asset('/images/cyriel.png')}}" alt="cyriel" name="Cyriel John Acocoro" role="Full-stack Developer | UX/UI Designer" about="Hello, I’m an IT student at SWU-PHINMA, with a passion for software development and UX/UI design. If you're interested in collaborating on an exciting project, let's make it happen - contact me using these link!" facebookLink="https://www.facebook.com/cyriel.acocoro" showFacebookIcon=true instagramLink="https://www.instagram.com/" showInstagramIcon=true linkedinLink="https://www.linkedin.com/in/cyriel-acocoro/" showLinkedinIcon=true />
                <x-developer-card avatar="{{asset('/images/danica.png')}}" alt="danica" name="Danica Marie Arnaiz" role="Project Manager | Backend Developer" about="Tech enthusiast with a passion for building innovative solutions. Skilled in web & mobile app development, UI/UX design, and project management. Eager to contribute to a dynamic team environment." facebookLink="https://www.facebook.com/nonononoway0" showFacebookIcon=true instagramLink="https://instagram.com/saintdaniiii" showInstagramIcon=true linkedinLink="https://linkedin.com/in/danica-arnaiz" showLinkedinIcon=true />
                <x-developer-card avatar="{{asset('/images/romnee.png')}}" alt="romnee" name="Romnee James Banaay" role="Quality Assuarance" about=" Hi! I'm Romnee James, a perpetual explorer of life's intricacies, a seeker of wisdom in everyday moments, and a passionate advocate for embracing the extraordinary in the ordinary. Join me on a journey through the kaleidoscope of my experiences, where every day is an opportunity to discover something new and meaningful." facebookLink="https://www.facebook.com/" showFacebookIcon=true instagramLink="https://www.instagram.com/" showInstagramIcon=true linkedinLink="https://www.instagram.com/" showLinkedinIcon=true />
                <x-developer-card avatar="{{asset('/images/lj.png')}}" alt="romnee" name="Lauren Jade Cuico Yting" role="Quality Assurance" about="Hi, I'm an IT student at SWU-PHINMA. I'm passionate about creating scalable and maintainable code that solves real-world problems. If you need help with your web application, let's work together to make it awesome!" facebookLink="https://www.facebook.com/" showFacebookIcon=true instagramLink="https://www.instagram.com/" showInstagramIcon=true linkedinLink="https://www.instagram.com/" showLinkedinIcon=true />
            </div>
        </section>
    </div>
</main>