    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-screen-xl prose-sm prose prose-slate prose-p:text-lg prose-li:text-base prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600">
            ...
            <ul class="marker:text-dark_gray-900 list-disc">
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SWU CPR.</li>
                <li><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</li>
                <li><strong>Country</strong> refers to: Philippines
                ...
                <li><strong>Website</strong> refers to SWU CPR, accessible from http://citeswu-001-site2.atempurl.com/</li>
