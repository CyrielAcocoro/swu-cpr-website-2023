<section class=" bg-dark_gray-900">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-20 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-5 prose prose-slate prose-p:text-slate-300 dark:prose-invert">
            <h1 class="max-w-2xl mb-4 bg-gradient-to-r from-yellow-400 via-purple-500 to-blue-900 bg-clip-text text-transparent text-phaser"><?php echo e($headlineTitle); ?></h1>
            <p class="max-w-2xl mb-6 lg:mb-8"><?php echo e($headlineDescription); ?></p>
...
</section><?php /**PATH C:\Users\acoco\OneDrive\Desktop\swu-cpr-website\resources\views/components/hero.blade.php ENDPATH**/ ?>